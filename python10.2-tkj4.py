...
koleksi_nama_hewan = ["Ubur ubur","Macan","Gurita","Cacing"]

koleksi_data_int = [100, 100, 100, 100]

koleksi_nama_teman = ["Rendra","Jamil","Rasyid Ridho","Opai"]

print("koleksi data string:", koleksi_nama_hewan)

print("koleksi data integer:", koleksi_data_int)

print("koleksi data string:", koleksi_nama_teman)
...
print("Nilai PTS Data ke-1:", koleksi_data_int[0])
